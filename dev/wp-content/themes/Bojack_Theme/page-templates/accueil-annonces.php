...
<section class="container" id="listeAnnonces">
  ...
  <div class="col-md-12">
    <?php get_template_part('/views/ajax-search') ?>
  </div>
  
  <div class="list-category-annonces col-md-12">
    <?php 
     $args_empty = array('hide_empty' => false);
    $terms = get_terms( 'categorie-annonce',$args_empty );
    if ( ! empty( $terms ) && ! is_wp_error( $terms ) ){
      echo '<ul><p><i class="fa fa-list"></i> Filtrer par catégories :</p>';
